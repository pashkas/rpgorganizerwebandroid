...
export abstract class GameSettings {
  ...
  revProbs: taskProb[] = [
    ...
    { id: 4, name: "обычный", prob: 1, gold: 100 }, // 500
    { id: 3, name: "редкий", prob: 0.25, gold: 400 }, // 2000
    { id: 2, name: "уникальный", prob: 0.1, gold: 1000 }, // 5000
    { id: 1, name: "легендарный", prob: 0.033, gold: 3000 }, // 15000
  ];
